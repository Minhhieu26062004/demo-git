...
<nav class="sidebar bg-primary">
                <ul>
                    <li>
                        <a href="#"><i class="fa-solid fa-house ico-side"></i>ADMIN</a>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        $sql = "select * from `tbl_nhanvien` order by tennhanvien";
        ...
        <!-- Button Thêm mới -->
        <a href="createNV.php" class="btn btn-primary">
...
$sql_timkiem = "SELECT * FROM `tbl_nhanvien` WHERE `tennhanvien` LIKE '%" .$tukhoa. "%' ";
$query_timkiem = mysqli_query($conn, $sql_timkiem);
} else {
$tukhoa = '';
$sql_timkiem = "SELECT * FROM `tbl_nhanvien` limit 20";
$query_timkiem = mysqli_query($conn, $sql_timkiem);
}
?>
<?php
$data = [];
        ...
        while ($rowtimkiem = mysqli_fetch_array($query_timkiem)) {
            $data[] = array(
                ...
                'ID' => $rowtimkiem['ID'],
                'tennhanvien' => $rowtimkiem['tennhanvien'],
                'diachi' => $rowtimkiem['diachi'],
            ...
            <tbody>
                <?php foreach ($data as $rowtimkiem) : ?>
                    <tr>
                        ...
                        <td><?php echo $rowtimkiem['tennhanvien']; ?></td>
                        <td><?php echo $rowtimkiem['diachi']; ?></td>
                        <td><img style="width: 80px; height: 80px;"src="images/<?php echo $rowtimkiem['anhmota'];?>"></td>

                       
                        <td>
                            <!-- Button Sửa -->
                            <a href="editNV.php?ID=<?php echo $rowtimkiem['ID']; ?>" id="btnUpdate" class="btn btn-primary">
                            <i class="fas fa-edit"></i>
                            </a>
                            </td>
                            <td>
                                 <!-- Button Xóa -->
                            <a href="deleteNV.php?ID=<?php echo $rowtimkiem['ID']; ?>" id="btnDelete" class="btn btn-danger">
